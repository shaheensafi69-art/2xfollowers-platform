"use client"; // حتماً خط اول باشد

import { useState } from 'react';
import { DollarSign, Package, Settings, Bell } from 'lucide-react';

// تنظیمات بیلد را به زیر ایمپورت‌ها منتقل کردیم
    ...
    <div className="min-h-screen bg-slate-50 p-6 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="col-span-1 lg:col-span-4 bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center justify-center">
          <div className="w-40 h-40 border-4 border-slate-100 rounded-full mb-6 flex items-center justify-center bg-slate-50 shadow-inner">
              <span className="text-4xl font-black text-emerald-500">2X</span>
          </div>
          <h3 className="font-bold text-slate-800 text-center leading-relaxed px-4 uppercase tracking-tight">
