  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 font-sans">
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-5 bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
          <h2 className="text-xl font-bold text-slate-800 mb-6">NEW ORDER</h2>
          <div className="space-y-4">
            <input placeholder="Search services..." className="w-full p-4 bg-slate-50 rounded-xl border border-slate-200" />
            ...
            <div className="grid grid-cols-2 gap-4">
              <input placeholder="Quantity" className="p-4 bg-slate-50 rounded-xl border border-slate-200" />
              <input placeholder="Link" className="p-4 bg-slate-50 rounded-xl border border-slate-200" />
            </div>
        ...
        <div className="col-span-4 bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center justify-center">
          <div className="w-40 h-40 border-4 border-slate-100 rounded-full mb-6" />
          <h3 className="font-bold text-slate-800 text-center">ELEVATE YOUR REACH, EFFORTLESSLY</h3>
        </div>
      </div>
    </div>
  );
