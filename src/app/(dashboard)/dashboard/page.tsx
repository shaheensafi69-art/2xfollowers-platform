"use client"; // حتماً باید خط اول باشد

import { useState, useEffect } from 'react';
import { createClient } from '@/utils/supabase/client';
import { Wallet, ShoppingBag, Clock, Bell, ArrowRight, PlusCircle, Loader2, AlertCircle } from 'lucide-react';
import Link from 'next/link';

// تنظیمات رندرینگ نکس‌جی‌اس
...
export default function DashboardPage() {
  ...
  const fetchData = async () => {
    ...
    // ۱. دریافت موجودی از جدول profiles
    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 font-medium">Welcome back to your growth hub.</p>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-slate-900 p-8 rounded-[2.5rem] text-white relative overflow-hidden h-full flex flex-col justify-between shadow-2xl shadow-slate-200">
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-black mb-3 text-emerald-400">2X Pro Access</h3>
              <p className="text-slate-400 font-medium leading-relaxed">
                Experience seamless payments and global coverage with our integrated fintech solutions.
              </p>
            </div>
